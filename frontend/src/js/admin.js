...
async function previewAdminBrandImage(input) {
    if (input.files && input.files[0]) {
        ...
        try {
            ...
            if (res.url) {
                document.getElementById('edit-brandImage').value = res.url;
                document.getElementById('admin-brand-preview').innerHTML = `<img src="${res.url}" style="width:100%; height:100%; object-fit:cover;">`;
            }
