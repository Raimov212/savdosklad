...
func (uc *TransactionUseCase) CreateSale(req entity.CreateTotalTransactionRequest) (int, error) {
...
func (uc *RefundUseCase) Create(req entity.CreateTotalRefundRequest) (int, error) {
...
func (uc *ExpenseUseCase) CreateTotalExpense(req entity.CreateTotalExpenseRequest) (int, error) {
	te := &entity.TotalExpense{BusinessID: req.BusinessID, Total: req.Total, Cash: req.Cash, Card: req.Card}
	if req.Description != "" {
		d := req.Description
		te.Description = &d
	}
